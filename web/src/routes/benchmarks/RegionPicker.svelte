...
<header class="detail-header">
	...
	<p class="detail-subtitle">
		Select the geographic region for this benchmark. The region determines which observation
		datasets and onset definitions are available.
	</p>
</header>
<hr class="divider" />
